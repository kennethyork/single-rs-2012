...
public final class Launcher {
    ...
    public static void main(String[] args) throws Exception {
		...
		if (!Settings.getConfig().isSinglePlayer()) {
			...
			Logger.info(Launcher.class, "main", "Single-player mode: using local file saves (MongoDB disabled).");
		}
		...
		if (!Settings.getConfig().isSinglePlayer()) {
			...
			Logger.info(Launcher.class, "main", "Single-player mode ready; remote lobby and web API disabled.");
		}
		addCleanMemoryTask();
