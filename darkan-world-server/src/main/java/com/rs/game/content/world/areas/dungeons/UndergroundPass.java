...
public class UndergroundPass {
	...
	public static ObjectClickHandler handleWellDoorEnter = new ObjectClickHandler(new Object[] { 3333, 3334 }, e -> e.getPlayer().useStairs(e.getPlayer().getX() < e.getObj().getX() ? Tile.of(2145, 4648, 1) : Tile.of(2014, 4712, 1)));
