...
fun mapPolypore() {
	...
	//handlePolyporeEntrance
	onObjectClick(63093, 63094) { e ->
		when (e.objectId) {
			63093 -> e.player.useStairs(-1, Tile.of(4620, 5458, 3), 0, 1)
			63094 -> e.player.useStairs(-1, Tile.of(3410, 3329, 0), 0, 1)
		}
	}

	onObjectClick(64359, 64360, 64361, 64362) { e ->
		val key = Triple(e.objectId, e.obj.x, e.obj.y)
	...
	onObjectClick("Neem drupes") { e ->
		if (e.option == "Pick") {
            ...
            val vb = e.obj.definitions.varpBit
