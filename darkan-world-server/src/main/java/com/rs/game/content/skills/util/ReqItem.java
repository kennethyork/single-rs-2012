...
public enum ReqItem {
	...
	IRON_INGOT_I(Category.ARTISANS, new Item(20632, 1), Skills.NONE, 1, 0.0, -1, new Item[] { new Item(441, 1) }),
	STEEL_INGOT_I(Category.ARTISANS, new Item(20633, 1), Skills.NONE, 1, 0.0, -1, new Item[] { new Item(441, 1), new Item(454, 2) }),
	MITHRIL_INGOT_I(Category.ARTISANS, new Item(20634, 1), Skills.NONE, 1, 0.0, -1, new Item[] { new Item(448, 1), new Item(454, 4) }),
	ADAMANT_INGOT_I(Category.ARTISANS, new Item(20635, 1), Skills.NONE, 1, 0.0, -1, new Item[] { new Item(450, 1), new Item(454, 6) }),
	RUNE_INGOT_I(Category.ARTISANS, new Item(20636, 1), Skills.NONE, 1, 0.0, -1, new Item[] { new Item(452, 1), new Item(454, 8) }),
	IRON_INGOT_II(Category.ARTISANS, new Item(20637, 1), Skills.NONE, 1, 0.0, -1, new Item[] { new Item(441, 9) }),
	STEEL_INGOT_II(Category.ARTISANS, new Item(20638, 1), Skills.NONE, 1, 0.0, -1, new Item[] { new Item(441, 4), new Item(454, 7) }),
	MITHRIL_INGOT_II(Category.ARTISANS, new Item(20639, 1), Skills.NONE, 1, 0.0, -1, new Item[] { new Item(448, 3), new Item(454, 12) }),
	ADAMANT_INGOT_II(Category.ARTISANS, new Item(20640, 1), Skills.NONE, 1, 0.0, -1, new Item[] { new Item(450, 3), new Item(454, 14) }),
	RUNE_INGOT_II(Category.ARTISANS, new Item(20641, 1), Skills.NONE, 1, 0.0, -1, new Item[] { new Item(452, 2), new Item(454, 16) }),
	IRON_INGOT_III(Category.ARTISANS, new Item(20642, 1), Skills.NONE, 1, 0.0, -1, new Item[] { new Item(441, 12) }),
	STEEL_INGOT_III(Category.ARTISANS, new Item(20643, 1), Skills.NONE, 1, 0.0, -1, new Item[] { new Item(441, 9), new Item(454, 17) }),
	MITHRIL_INGOT_III(Category.ARTISANS, new Item(20644, 1), Skills.NONE, 1, 0.0, -1, new Item[] { new Item(448, 6), new Item(454, 24) }),
	ADAMANT_INGOT_III(Category.ARTISANS, new Item(20645, 1), Skills.NONE, 1, 0.0, -1, new Item[] { new Item(450, 4), new Item(454, 22) }),
	RUNE_INGOT_III(Category.ARTISANS, new Item(20646, 1), Skills.NONE, 1, 0.0, -1, new Item[] { new Item(452, 4), new Item(454, 30) }),
	IRON_INGOT_IV(Category.ARTISANS, new Item(20648, 1), Skills.NONE, 1, 0.0, -1, new Item[] { new Item(441, 75) }),
	STEEL_INGOT_IV(Category.ARTISANS, new Item(20649, 1), Skills.NONE, 1, 0.0, -1, new Item[] { new Item(441, 40), new Item(454, 80) }),
	MITHRIL_INGOT_IV(Category.ARTISANS, new Item(20650, 1), Skills.NONE, 1, 0.0, -1, new Item[] { new Item(448, 30), new Item(454, 120) }),
	ADAMANT_INGOT_IV(Category.ARTISANS, new Item(20651, 1), Skills.NONE, 1, 0.0, -1, new Item[] { new Item(450, 25), new Item(454, 150) }),
	RUNE_INGOT_IV(Category.ARTISANS, new Item(20652, 1), Skills.NONE, 1, 0.0, -1, new Item[] { new Item(452, 18), new Item(454, 144) }),
