...
public class Mining extends Action {
	...
	public static ObjectClickHandler handleEss = new ObjectClickHandler(new Object[] { 2491, "Rune essence rock" },
			e -> e.getPlayer().getActionManager().setAction(new Mining(RockType.ESSENCE, e.getObj())));

	public static ObjectClickHandler handleLunar = new ObjectClickHandler(new Object[] { "Stalagmite", "Stalagmites" },
			e -> e.getPlayer().getActionManager().setAction(new Mining(RockType.LUNAR, e.getObj())));
