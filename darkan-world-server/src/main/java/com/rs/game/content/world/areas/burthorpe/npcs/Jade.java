    ...
    public Jade(Player player, NPC npc) {
        ...
        addOptions(new Options() {
            ...
            public void create() {
                ...
                option("I'd like to change my threshold for valuable loot notifications.", new Dialogue()
                        .addPlayer(HeadE.HAPPY_TALKING, "I'd like to change my threshold for valuable loot notifications.")
                        ...
                        })).addNPC(npc.getId(), HeadE.HAPPY_TALKING, "Would you like to enable lootbeams?").addOptions(new Options() {
                            @Override
                            public void create() {
                                option("Yes, the colorful one!", new Dialogue()
                                        .addNPC(npc.getId(), HeadE.CHEERFUL_EXPOSITION, "Alright, you will see colorful lootbeams over your valuable drops.", () -> player.set("lootbeamAnim", 2793)));
                                option("Yes, the golden one!", new Dialogue()
                                        .addNPC(npc.getId(), HeadE.CHEERFUL_EXPOSITION, "Alright, you will see golden lootbeams over your valuable drops.", () -> player.set("lootbeamAnim", 2794)));
                                option("No thanks.", new Dialogue()
                                        .addNPC(npc.getId(), HeadE.CALM_TALK, "Alright, you won't see lootbeams over your valuable drops.", () -> player.set("lootbeamAnim", 0)));
