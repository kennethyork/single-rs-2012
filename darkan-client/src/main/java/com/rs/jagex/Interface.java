...
public class Interface {
		...
		for (int i_1 = 0; i_1 < Class260.SOUNDS_SIZE; i_1++) {
			...
			if (sound.aNode_Sub15_Sub5_3304 == null) {
				...
				if (sound.delay >= (sound.isVorbis() ? -1500 : -10)) {
					if (sound.type == SoundType.EFFECT && sound.soundEffect == null) {
					...
					} else if (sound.isVorbis() && (sound.aNode_Sub18_3294 == null || sound.aNode_Sub26_Sub1_Sub1_3296 == null)) {
					...
					if (sound.delay < 0) {
						...
						if (sound.sourceTile != 0) {
							...
							if (i_6 == VertexNormal.MY_PLAYER.plane) {
								...
								if (i_11 != 0 || i_13 != 0) {
									int i_15 = -Camera.anInt5930 - (int) (Math.atan2(i_11, i_13) * 2607.5945876176133D) - 4096 & 0x3fff;
									if (i_15 > 8192)
										i_15 = 16384 - i_15;
									int i_16;
									if (i_14 <= 0)
							...
							i_5 = sound.volume * (sound.type == SoundType.VOICE ? Class393.preferences.voiceOverVolume.method12714() : Class393.preferences.soundEffectVolume.method12714()) >> 2;
						if (i_5 > 0) {
							if (sound.type == SoundType.EFFECT) {
								...
								sound.aNode_Sub15_Sub5_3304 = class282_sub26_sub1_sub2_19.method15225(sound.sampleRate, i_5, i_4);
							} else if (sound.isVorbis())
								sound.aNode_Sub15_Sub5_3304 = sound.aNode_Sub26_Sub1_Sub1_3296.method15225(sound.sampleRate, i_5, i_4);
							sound.aNode_Sub15_Sub5_3304.setUnk0to8(sound.unk0to8 - 1);
	...
	public static AccountCreationResponseOpcodes[] method1626() {
		return new AccountCreationResponseOpcodes[] { AccountCreationResponseOpcodes.aClass483_5729, AccountCreationResponseOpcodes.CLIENT_HAS_BEEN_UPDATED, AccountCreationResponseOpcodes.CONTINUE, AccountCreationResponseOpcodes.aClass483_5733, AccountCreationResponseOpcodes.aClass483_5730, AccountCreationResponseOpcodes.aClass483_5735, AccountCreationResponseOpcodes.aClass483_5732, AccountCreationResponseOpcodes.aClass483_5736, AccountCreationResponseOpcodes.aClass483_5737,
				AccountCreationResponseOpcodes.aClass483_5731 };
	}
