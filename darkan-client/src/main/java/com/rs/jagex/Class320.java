...
public class Class320 {
	...
	public static void playMusicAtTile(int x, int y, int i_3, int i_4, int id, int volume) {
		Class42.playSoundSong(id, volume, 100);
		Class260.aClass277_3234 = new Class277(x << 9, y << 9, i_3 << 8, i_4 * 8);
	}
