...
public class MapRegion {
	...
	static void method4561(int i_0, int i_1, int i_2, int i_3, int i_4, int i_5) {
		...
		for (i_9 = i_2; i_9 < i_7; i_9++)
			KeyHoldInputSubscriber.method3922(Class532.anIntArrayArray7072[i_9], i_0, i_1, i_4);
		for (i_9 = i_3; i_9 > i_8; --i_9)
			KeyHoldInputSubscriber.method3922(Class532.anIntArrayArray7072[i_9], i_0, i_1, i_4);
		i_9 = i_5 + i_0;
		int i_10 = i_1 - i_5;
		for (int i_11 = i_7; i_11 <= i_8; i_11++) {
			int[] ints_12 = Class532.anIntArrayArray7072[i_11];
	...
	void loadMapSceneBackground() {
		...
		int i_2 = coordGrid.x;
		int i_3 = coordGrid.y;
		int mapBaseX = (Camera.CAM_MOVE_ABSOLUTEX >> 12) + (i_2 >> 3);
		int mapBaseY = (Camera.CAM_MOVE_ABSOLUTEY >> 12) + (i_3 >> 3);
	...
	void method4459(GameState state) {
		...
		for (Node_Sub29 class282_sub29_27 = (Node_Sub29) client.GROUND_ITEMS.method7750(); class282_sub29_27 != null; class282_sub29_27 = (Node_Sub29) client.GROUND_ITEMS.method7751()) {
		...
		if (state == GameState.UNK_18) {
			...
			Camera.CAM_MOVE_LOCALX -= i_3;
			Camera.CAM_MOVE_LOCALY -= i_4;
			Camera.CAM_LOOK_ABSOLUTE_X -= i_3;
			Camera.CAM_LOOK_ABSOLUTE_Y -= i_4;
			Camera.CAM_MOVE_ABSOLUTEX -= i_3 * 512;
			Camera.CAM_MOVE_ABSOLUTEY -= i_4 * 512;
