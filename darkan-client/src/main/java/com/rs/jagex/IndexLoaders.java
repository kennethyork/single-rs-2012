...
public class IndexLoaders {
	...
	public static int initializeGame() {
		...
		if (LOADING_STAGE == LoadingStage.aClass387_4708) {
			if (Class302.anInterface27Array3559 != null && Class302.anInterface27Array3559.length > 0) {
				if ((Class302.anInterface27Array3559[0].method191() < 100) || (Class302.anInterface27Array3559.length > 1 && EntityNode_Sub7.GAME_TIPS_LOADER.method6790() && Class302.anInterface27Array3559[1].method191() < 100))
					return 0;
			}
		...
		if (LoadingStage.aClass387_4710 == LOADING_STAGE) {
			...
			Class358.method6234();
			client.aBool7465 = Boolean.getBoolean("darkan.singlePlayer") || Class393.preferences.safeMode.getValue() == 1;
			Class393.preferences.setValue(Class393.preferences.safeMode, 1);
			if (client.aBool7465 || (Class393.preferences.toolKit.aBool7914 && Class11.SYSTEM_INFO.ram < 512 && Class11.SYSTEM_INFO.ram != 0))
	...
	public static Index loadIndex(IndexReference indexreference_0, boolean bool_1, int i_2) {
		...
		if (Engine.aClass440_3270 != null)
			js5cachefile_4 = new JS5CacheFile(i_5, Engine.aClass440_3270, Class97.aClass440Array996[i_5]);
