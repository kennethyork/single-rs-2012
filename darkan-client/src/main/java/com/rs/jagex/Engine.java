...
public abstract class Engine implements Interface24, Runnable, FocusListener, WindowListener {
	...
	void method4656(String string_1, String string_2, int i_3, int i_4) throws Exception {
		...
		// The revision 727 cache is larger than the original 500 MiB ceiling. Class442
		// deletes files above its ceiling, so leave enough room for the bundled HD cache.
		aClass440_3270 = new UID192(new Class442(CutsceneAction_Sub23.method14681("main_file_cache.dat2"), 2_000_000_000L), 5200);
	...
	void method4659(File file_1, File file_2) {
		try {
			...
			class442_4.writeBytesToFile(rsbytebuffer_5.buffer, 0, rsbytebuffer_5.index);
