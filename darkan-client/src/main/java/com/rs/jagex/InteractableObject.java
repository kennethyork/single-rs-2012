...
public class InteractableObject extends GraphNode_Sub1_Sub1 implements WorldObject {
	...
	public static void method16099(IComponentDefinitions[] arr_0, int i_1, int i_2, int i_3, boolean bool_4) {
		for (IComponentDefinitions element : arr_0) {
			IComponentDefinitions icomponentdefinitions_7 = element;
	...
	@Override
	public int getId() {
		return aClass123_10509.objectId;
	}
	...
	@Override
	public int method39() {
		return aClass123_10509.objectId * 1623064993 * 1535779425;
	}
