...
public abstract class Node_Sub15_Sub5 extends Node_Sub15 {
	...
	public synchronized void method12234(int i_1) {
		...
		if (1507503163 * unk0to8 * -485012237 < 0) {
			if (aBool9857) {
				if (anInt9855 * 1927994969 * -177305111 * 1927994969 * -177305111 < 0) {
			...
			if (unk0to8 * -485012237 * 1507503163 > 0)
				if (aBool9857)
					...
					if (-177305111 * anInt9855 * 1927994969 * -177305111 * 1927994969 < 0) {
						...
						if (i_6 < unk0to8 * -485012237 * 1507503163) {
							anInt9853 = (anInt9853 * -834443097 + -834443097 * i_5 * i_6) * -354697449;
							unk0to8 = (unk0to8 * -485012237 - i_6 * -485012237) * 1507503163;
							return;
						}

						anInt9853 = (anInt9853 * -834443097 + -834443097 * 1507503163 * unk0to8 * -485012237 * i_5) * -354697449;
					} else {
						if (-354697449 * anInt9853 * -834443097 < i_3)
							return;

						i_6 = (-354697449 * anInt9853 * -834443097 - i_2) / i_5;
						if (i_6 < 1507503163 * unk0to8 * -485012237) {
							anInt9853 = (anInt9853 * -834443097 - -834443097 * i_5 * i_6) * -354697449;
							unk0to8 = (unk0to8 * -485012237 - i_6 * -485012237) * 1507503163;
							return;
						}

						anInt9853 = (anInt9853 * -834443097 - -834443097 * i_5 * unk0to8 * -485012237 * 1507503163) * -354697449;
					}
					unk0to8 = 0;
				}
	...
	public synchronized void setUnk0to8(int i_1) {
		unk0to8 = i_1;
	}
