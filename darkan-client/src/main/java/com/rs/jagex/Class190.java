...
public class Class190 {
	...
	static void method3151(int i_0, int i_1, IComponentDefinitions icomponentdefinitions_2, Class119 class119_3, int i_4, int i_5) {
		...
		for (HintArrow arrow : hintArrows) {
	...
	static void method3152() {
		...
		Camera.camAngleY = ((int) (Math.random() * 160.0D) - 80 & 0x3fff);
		...
		client.GROUND_ITEMS.method7749();
		...
		Camera.CAM_MOVE_LOCALX = 0;
		Camera.CAM_MOVE_LOCALY = 0;
		Camera.CAM_MOVE_Z = 0;
		Camera.CAM_MOVE_CONST_SPEED = 0;
		Camera.CAM_MOVE_VAR_SPEED = 0;
		Camera.CAM_LOOK_ABSOLUTE_X = 0;
		Camera.CAM_LOOK_ABSOLUTE_Y = 0;
		Camera.CAM_LOOK_ABSOLUTE_Z = 0;
		Camera.anInt5606 = 0;
		Camera.anInt5828 = 0;
	...
	public static void savePreferences() {
		...
		try {
			...
			class442_1.writeBytesToFile(rsbytebuffer_2.buffer, 0, rsbytebuffer_2.index);
