...
public class Node_Sub15_Sub5_Sub2 extends Node_Sub15_Sub5 {
	...
	static int method15998(int i_1, byte[] bytes_2, int[] ints_3, int i_4, int i_5, int i_6, int i_7, int i_8, int i_9, Node_Sub15_Sub5_Sub2 class282_sub15_sub5_sub2_10, int i_11, int i_12) {
		int i_71 = i_7;
		int i_13 = i_1;
	...
	static int method16006(int i_1, byte[] bytes_2, int[] ints_3, int i_4, int i_5, int i_6, int i_7, int i_8, int i_9, int i_10, Node_Sub15_Sub5_Sub2 class282_sub15_sub5_sub2_11, int i_12, int i_13) {
		int i_81 = i_8;
		int i_11 = i_1;
		class282_sub15_sub5_sub2_11.anInt9845 -= class282_sub15_sub5_sub2_11.anInt9852 * i_5;
		class282_sub15_sub5_sub2_11.anInt9850 -= class282_sub15_sub5_sub2_11.anInt9851 * i_5;
	...
	public synchronized void method12240(int[] ints_1, int i_2, int i_3) {
		if (anInt9846 * -298675253 * -1302038045 == 0 && anInt9858 * 1156515807 * 1008956447 == 0)
			...
			if (unk0to8 * -485012237 * 1507503163 < 0) {
				if (aBool9857) {
					if (anInt9855 * 1927994969 * -177305111 * 1927994969 * -177305111 < 0) {
				...
				if (unk0to8 * -485012237 * 1507503163 > 0)
					if (aBool9857)
						...
						if (anInt9855 * 1927994969 * -177305111 * 1927994969 * -177305111 < 0) {
							...
							anInt9853 = (i_4 + i_4 - 1 - anInt9853 * -834443097 * -354697449) * -834443097 * -354697449;
							anInt9855 = -(anInt9855 * 1927994969 * -177305111 * 1927994969) * -177305111 * 1927994969 * -177305111;
							i_10002 = unk0to8 * -485012237 - -485012237;
							unk0to8 = (unk0to8 * -485012237 - -485012237) * 1507503163;
						...
						if (anInt9855 * 1927994969 * -177305111 * 1927994969 * -177305111 < 0)
							while (true) {
								...
								if (i_9 >= unk0to8 * -485012237 * 1507503163) {
									anInt9853 = (anInt9853 * -834443097 + i_7 * unk0to8 * -485012237 * 1507503163 * -834443097) * -354697449;
									unk0to8 = 0;
									break;
								}

								anInt9853 = (anInt9853 * -834443097 + i_7 * i_9 * -834443097) * -354697449;
								unk0to8 = (unk0to8 * -485012237 - i_9 * -485012237) * 1507503163;
							}
						else
							while (true) {
								i_8 = method15990(ints_1, i_8, i_5, i_3, ((Node_Sub26_Sub1_Sub2) aNode_Sub26_7601).aByteArray10470[anInt9844 * 900940833 * -99794975]);
