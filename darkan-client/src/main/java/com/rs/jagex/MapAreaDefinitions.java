...
public class MapAreaDefinitions {
			...
			if (npcDefinitions.visible) {
				...
				if (client.IS_USE_SELECTED && !bool_1) {
					...
					if ((Class506.USE_OPTIONS_FLAGS & 0x2) != 0 && (attributedefault_10 == null || npcDefinitions.method6876(CutsceneAction_Sub12.TARGET_PARAM, attributedefault_10.defaultInt) != attributedefault_10.defaultInt))
						PlayerModel.method4032(client.aString7275, client.aString7356 + " " + "->" + " " + Utils.rgbToColHexShortcut(16776960) + string_4, Defaults8Loader.anInt5932, MenuAction.TGT_NPC, -1, npc_0.index, 0, 0, true, false, npc_0.index, false);
				}
				if (!bool_1) {
					...
					if (options != null) {
						...
						for (index = options.length - 1; index >= 0; --index)
							if (options[index] != null && (npcDefinitions.aByte4916 == 0 || !options[index].equalsIgnoreCase(LocalizedText.ATTACK.translate(Class223.CURRENT_LANGUAGE)) && !options[index].equalsIgnoreCase(LocalizedText.EXAMINE.translate(Class223.CURRENT_LANGUAGE)))) {
								...
								if (index == 0)
									action = MenuAction.OP_NPC1;
								if (index == 1)
									action = MenuAction.OP_NPC2;
								if (index == 2)
									action = MenuAction.OP_NPC3;
								if (index == 3)
									action = MenuAction.OP_NPC4;
								if (index == 4)
									action = MenuAction.OP_NPC5;
								if (index == 5)
									action = MenuAction.OP_NPC6;
								...
								PlayerModel.method4032(options[index], Utils.rgbToColHexShortcut(16776960) + string_4, options[index].equalsIgnoreCase(LocalizedText.ATTACK.translate(Class223.CURRENT_LANGUAGE)) ? npcDefinitions.anInt4877 : i_8, action, -1, npc_0.index, 0, 0, true, false, npc_0.index, false);
							}
						if (npcDefinitions.aByte4916 == 1)
							for (index = 0; index < options.length; index++)
								if (options[index] != null && (options[index].equalsIgnoreCase(LocalizedText.ATTACK.translate(Class223.CURRENT_LANGUAGE)) || options[index].equalsIgnoreCase(LocalizedText.EXAMINE.translate(Class223.CURRENT_LANGUAGE)))) {
									...
									if (index == 0)
										action = npc_0.anInt10582 > VertexNormal.MY_PLAYER.combatLevel ? MenuAction.OP_NPC1_LOWPRIORITY : MenuAction.OP_NPC1;
									if (index == 1)
										action = npc_0.anInt10582 > VertexNormal.MY_PLAYER.combatLevel ? MenuAction.OP_NPC2_LOWPRIORITY : MenuAction.OP_NPC2;
									if (index == 2)
										action = npc_0.anInt10582 > VertexNormal.MY_PLAYER.combatLevel ? MenuAction.OP_NPC3_LOWPRIORITY : MenuAction.OP_NPC3;
									if (index == 3)
										action = npc_0.anInt10582 > VertexNormal.MY_PLAYER.combatLevel ? MenuAction.OP_NPC4_LOWPRIORITY : MenuAction.OP_NPC4;
									if (index == 4)
										action = npc_0.anInt10582 > VertexNormal.MY_PLAYER.combatLevel ? MenuAction.OP_NPC5_LOWPRIORITY : MenuAction.OP_NPC5;
									if (index == 5)
										action = npc_0.anInt10582 > VertexNormal.MY_PLAYER.combatLevel ? MenuAction.OP_NPC6_LOWPRIORITY : MenuAction.OP_NPC6;
									if (index == npcDefinitions.anInt4875)
										i_9 = npcDefinitions.anInt4873;
									if (index == npcDefinitions.anInt4854)
										i_9 = npcDefinitions.anInt4861;
									PlayerModel.method4032(options[index], Utils.rgbToColHexShortcut(16776960) + string_4, options[index].equalsIgnoreCase(LocalizedText.ATTACK.translate(Class223.CURRENT_LANGUAGE)) ? npcDefinitions.anInt4877 : i_9, action, -1, npc_0.index, 0, 0, true, false, npc_0.index, false);
								}
					}
				}
			}
	...
	static boolean renderIconsAndNames(AbstractRenderer graphicalrenderer_0, Node_Sub36 class282_sub36_1, MapAreaDefinitions worldmapareadefs_2) {
		...
		if (worldmapareadefs_2.anIntArray2717 != null) {
			i_6 = (Class291.anInt3476 - Class291.anInt3489) * (worldmapareadefs_2.anInt2747 + class282_sub36_1.anInt7987 - Class291.anInt3485) / (Class291.anInt3480 - Class291.anInt3485) + Class291.anInt3489;
			i_7 = Class291.anInt3489 + (Class291.anInt3476 - Class291.anInt3489) * (worldmapareadefs_2.anInt2731 + class282_sub36_1.anInt7987 - Class291.anInt3485) / (Class291.anInt3480 - Class291.anInt3485);
			i_9 = Class291.anInt3492 - (Class291.anInt3492 - Class291.anInt3490) * (worldmapareadefs_2.anInt2744 + class282_sub36_1.anInt7993 - Class291.anInt3465) / (Class291.anInt3486 - Class291.anInt3465);
			i_8 = Class291.anInt3492 - (Class291.anInt3492 - Class291.anInt3490) * (worldmapareadefs_2.anInt2746 + class282_sub36_1.anInt7993 - Class291.anInt3465) / (Class291.anInt3486 - Class291.anInt3465);
		}
		...
		if (worldmapareadefs_2.areaName != null) {
			...
			if (class194_15 != null) {
				i_16 = Node_Sub17_Sub2.aClass414_9933.getLineCount(worldmapareadefs_2.areaName, null, Class291_Sub1.aStringArray8024, null);
				i_17 = (Class291.anInt3476 - Class291.anInt3489) * worldmapareadefs_2.anInt2750 / (Class291.anInt3480 - Class291.anInt3485) + class282_sub36_1.anInt7990;
				i_18 = class282_sub36_1.anInt7992 - (Class291.anInt3492 - Class291.anInt3490) * worldmapareadefs_2.anInt2752 / (Class291.anInt3486 - Class291.anInt3465);
				if (nativesprite_10 == null)
		...
		if ((i_7 < Class291.anInt3489) || (i_6 > Class291.anInt3476) || (i_9 < Class291.anInt3490) || (i_8 > Class291.anInt3492))
			return true;
		Class291.method5147(graphicalrenderer_0, class282_sub36_1, worldmapareadefs_2);
		if (nativesprite_10 != null) {
	...
	public NativeSprite renderIcons(AbstractRenderer graphicalrenderer_1, boolean bool_2) {
		...
		if (!aClass218_2716.aClass317_2703.loadFile(i_4))
			return null;
		else {
