				...
				if (i_8 != -1 && i_9 != -1)
					if (client.IS_USE_SELECTED && (Class506.USE_OPTIONS_FLAGS & 0x40) != 0) {
						...
						if (icomponentdefinitions_30 != null)
							PlayerModel.method4032(client.aString7275, " -> ", Defaults8Loader.anInt5932, MenuAction.TGT_GROUND, -1, 0L, i_8, i_9, true, false, i_8 << 0 | i_9, true);
						else
							Class60.method1170();
					} else {
						if (CutsceneAction_Sub6.SHOW_FACE_HERE)
							PlayerModel.method4032(LocalizedText.FACE_HERE.translate(Class223.CURRENT_LANGUAGE), "", -1, MenuAction.FACE_SQUARE, -1, 0L, i_8, i_9, true, false, i_8 << 0 | i_9, true);

						PlayerModel.method4032(Class85.aString817, "", client.anInt7311, MenuAction.WALK, -1, 0L, i_8, i_9, true, false, i_8 << 0 | i_9, true);
					}
			}
			...
			while (true) {
				...
				do {
					...
					do {
						...
						i_47 = (int) vector3_35.z >> 9;
										...
										if (!(class285_34.aTransform_Sub1_3391 instanceof PlayerEntity player_58))
											break;
									...
									if (!(class285_34.aTransform_Sub1_3391 instanceof NPCEntity npc_59))
										break;
								...
								if (class285_34.aTransform_Sub1_3391 instanceof GroundItem) {
									...
									Node_Sub29 class282_sub29_61 = (Node_Sub29) client.GROUND_ITEMS.get(class285_34.aTransform_Sub1_3391.plane << 28 | i_49 << 14 | i_48);
										...
										for (GroundItemNode class282_sub34_39 = (GroundItemNode) class282_sub29_61.aClass482_7708.method8065(); class282_sub34_39 != null; i_21++) {
											...
											if (client.IS_USE_SELECTED && class285_34.aTransform_Sub1_3391.plane == VertexNormal.MY_PLAYER.plane) {
												...
												if ((Class506.USE_OPTIONS_FLAGS & 0x1) != 0 && (attributedefault_68 == null || itemdefinitions_65.getCS2Integer(CutsceneAction_Sub12.TARGET_PARAM, attributedefault_68.defaultInt) != attributedefault_68.defaultInt))
													PlayerModel.method4032(client.aString7275, client.aString7356 + " " + "->" + " " + Utils.rgbToColHexShortcut(i_38) + itemdefinitions_65.name, Defaults8Loader.anInt5932, MenuAction.TGT_GROUND_ITEM, -1, class282_sub34_39.id, i_46, i_47, true, false, i_21, false);
											}
											...
											if (class285_34.aTransform_Sub1_3391.plane == VertexNormal.MY_PLAYER.plane) {
												...
												for (i_42 = arr_69.length - 1; i_42 >= 0; --i_42)
													if (arr_69[i_42] != null) {
														...
														if (i_42 == 0)
															action = MenuAction.OP_GROUND_ITEM1;

														if (i_42 == 1)
															action = MenuAction.OP_GROUND_ITEM2;

														if (i_42 == 2)
															action = MenuAction.OP_GROUND_ITEM3;

														if (i_42 == 3)
															action = MenuAction.OP_GROUND_ITEM4;

														if (i_42 == 4)
															action = MenuAction.OP_GROUND_ITEM5;

														if (i_42 == 5)
															action = MenuAction.OP_GROUND_ITEM6;
														...
														PlayerModel.method4032(arr_69[i_42], Utils.rgbToColHexShortcut(i_38) + itemdefinitions_65.name, i_28, action, -1, class282_sub34_39.id, i_46, i_47, true, false, i_21, false);
													}
											}
						...
						if (client.IS_USE_SELECTED && class285_34.aTransform_Sub1_3391.plane == VertexNormal.MY_PLAYER.plane) {
							...
							if ((Class506.USE_OPTIONS_FLAGS & 0x4) != 0 && (attributedefault_62 == null || objectdefinitions_57.method7963(CutsceneAction_Sub12.TARGET_PARAM, attributedefault_62.defaultInt) != attributedefault_62.defaultInt))
								PlayerModel.method4032(client.aString7275, client.aString7356 + " " + "->" + " " + Utils.rgbToColHexShortcut(65535) + objectdefinitions_57.name, Defaults8Loader.anInt5932, MenuAction.TGT_OBJ, -1, Class329.method5905(sceneobject_60, i_46, i_47), i_46, i_47, true, false, sceneobject_60.hashCode(), false);
						}
				...
				for (i_21 = arr_63.length - 1; i_21 >= 0; --i_21)
					if (arr_63[i_21] != null) {
						...
						if (i_21 == 0)
							action = MenuAction.OP_OBJ1;

						if (i_21 == 1)
							action = MenuAction.OP_OBJ2;

						if (i_21 == 2)
							action = MenuAction.OP_OBJ3;

						if (i_21 == 3)
							action = MenuAction.OP_OBJ4;

						if (i_21 == 4)
							action = MenuAction.OP_OBJ5;

						if (i_21 == 5)
							action = MenuAction.OP_OBJ6;
						...
						PlayerModel.method4032(arr_63[i_21], Utils.rgbToColHexShortcut(65535) + objectdefinitions_57.name, i_51, action, -1, Class329.method5905(sceneobject_60, i_46, i_47), i_46, i_47, true, false, sceneobject_60.hashCode(), false);
					}
			}
		}
	}
