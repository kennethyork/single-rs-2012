...
public class AreadSound {
		...
		if ((Class20.anInt169 >= 2 || client.IS_USE_SELECTED) && client.aClass118_7257 == null) {
			...
			if (client.IS_USE_SELECTED && Class20.anInt169 < 2)
				string_2 = client.aString7275 + LocalizedText.aClass433_5315.translate(Class223.CURRENT_LANGUAGE) + client.aString7356 + " " + "->";
					...
					MenuActionEvent class282_sub50_sub7_3 = CutsceneAction_Sub23.aCacheableNode_Sub7_9445;
	...
	public enum SoundType {
		...
		static final Map<Byte, SoundType> MAP = new HashMap<>();
		...
		public static SoundType forId(byte id) {
			return MAP.get(id);
		}
	}
	...
	AreadSound(SoundType type, int soundId, int i_3, int delay, int volume, int sourceTile, int sampleRate, GraphNode_Sub1 class521_sub1_8) {
		this.type = type;
	...
	boolean isVorbis() {
		return type == SoundType.VORBIS_EFFECT || type == SoundType.VOICE;
	}
}
