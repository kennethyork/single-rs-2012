...
public class IComponentDefinitions {
	...
	public static void render(IComponentDefinitions[] components, int i_1, int endX, int endY, int startX, int startY, int i_6, int i_7, int layer, boolean bool_9) {
		...
		for (IComponentDefinitions component : components) {
			IComponentDefinitions inter = component;
					...
					if (toX < fromX && toY < fromY) {
						...
						if (inter.type == ComponentType.CONTAINER) {
							if (inter.contentType == ContentType.CONTENT_TYPE_1407 && Renderers.CURRENT_RENDERER.method8471())
								Renderers.CURRENT_RENDERER.method8525(ChangeClanSetting.BASE_WINDOW_WIDTH, Engine.BASE_WINDOW_HEIGHT * -969250379);
									...
									if (inter.type == ComponentType.SPRITE) {
										...
										if (meshRasterizer != null) {
											...
											if (inter.usesOrthogonal) {
												if (inter.hasOrigin)
													matrix44_38.method6532(i_39, i_27, i_24, i_25, i_29, i_30, ChangeClanSetting.BASE_WINDOW_WIDTH, (Engine.BASE_WINDOW_HEIGHT * -969250379), inter.spriteScale);
												else
													matrix44_38.method6532(i_39, i_27, i_24, i_25, i_29, i_30, ChangeClanSetting.BASE_WINDOW_WIDTH, (Engine.BASE_WINDOW_HEIGHT * -969250379), (inter.spriteScale << 2));
											} else
												matrix44_38.method6531(i_39, i_27, i_24, i_25, i_29, i_30, ChangeClanSetting.BASE_WINDOW_WIDTH, (Engine.BASE_WINDOW_HEIGHT * -969250379));
	...
	public int lightPositionX;
	public int lightPositionY;
	public int lightPositionZ;
	...
	public MeshRasterizer method2002(AbstractRenderer graphicalrenderer_1, int i_2, RenderAnimIndexLoader renderanimindexloader_3, IdentiKitIndexLoader class31_4, NPCIndexLoader npcindexloader_5, ItemIndexLoader itemindexloader_6, VarProvider interface42_8, Animation animation_9, PlayerModel playerappearance_10) {
		...
		if (modelType == ModelType.NONE)
			return null;
		if (modelType == ModelType.RAW_MODEL && modelId == -1)
			return null;
		...
		long_13 = long_13 >>> 8 ^ longs_26[(int) ((long_13 ^ colorsToReplace[i_16]) & 0xffL)];
			...
			if (modelType == ModelType.NPC_HEAD) {
				...
				if (meshrasterizer_23 == null) {
					...
					return meshrasterizer_23;
			} else if ((modelType != ModelType.PLAYER_HEAD_IGNOREWORN) || (playerappearance_10 == null))
				return null;
			else {
	...
	public Class247 method2027(SkyboxIndexLoader class288_1, SunIndexLoader class45_2) {
		if (skyboxId == -1)
			return null;
		long long_4 = (lightPositionX & 0xffffL) << 48 | (lightPositionY & 0xffffL) << 32 | (lightPositionZ & 0xffffL) << 16 | skyboxId & 0xffffL;
		Class247 class247_6 = (Class247) aClass229_1282.get(long_4);
		if (class247_6 == null) {
			class247_6 = class288_1.method5077(skyboxId, lightPositionX, lightPositionY, lightPositionZ, class45_2);
