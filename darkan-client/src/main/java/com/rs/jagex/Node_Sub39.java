	...
	static void method13297(AbstractRenderer graphicalrenderer_0, Node_Sub36 class282_sub36_1, MapAreaDefinitions worldmapareadefs_2) {
		...
		if (nativesprite_4 != null) {
			...
			if (worldmapareadefs_2.areaName != null) {
				i_9 = Node_Sub17_Sub2.aClass414_9933.getLineCount(worldmapareadefs_2.areaName, null, Class291_Sub1.aStringArray8024, null);
			...
			if (i_7 < i_5 + Class291.anInt3489) {
				i_7 = Class291.anInt3489;
				i_12 = i_5 / 2 + i_10 / 2 + b_6 + Class291.anInt3489 + 5;
			} else if (i_7 > Class291.anInt3476 - i_5) {
				i_7 = Class291.anInt3476 - i_5;
				i_12 = Class291.anInt3476 - i_5 / 2 - b_6 - i_10 / 2 - 5;
			}

			if (i_8 < i_5 + Class291.anInt3490) {
				i_8 = Class291.anInt3490;
				i_13 = i_5 / 2 + b_6 + Class291.anInt3490;
			} else if (i_8 > Class291.anInt3492 - i_5) {
				i_8 = Class291.anInt3492 - i_5;
				i_13 = Class291.anInt3492 - i_5 / 2 - b_6 - i_11;
			}
