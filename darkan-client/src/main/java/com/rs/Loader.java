...
public class Loader extends Panel implements ImageObserver, MenuContainer, Serializable, Accessible {
	...
	public static final String OFFLINE_CACHE_PATH = System.getProperty("darkan.cache.path", "");
	...
	public static int RENDER_DISTANCE_MULTIPLIER = 1; //Default 1
	public static int FOG_DISTANCE_MULTIPLIER = 1; //Default 1
	public static boolean X10_HITS_MODE = false;

	public static Loader INSTANCE;

	public static int getPort(int worldId) {
		if (Boolean.getBoolean("darkan.singlePlayer"))
			return WORLD_PORT;
